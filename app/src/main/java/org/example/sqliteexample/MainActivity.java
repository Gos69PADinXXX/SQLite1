...
//НАХОЖУ КОМПОНЕНТЫ ИЗ xml
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String product = "";
  Cursor cursor = mDb.rawQuery("SELECT * FROM clients_GKII", null);
                cursor.moveToFirst();
 ...
 cursor.moveToNext();
  ...
  textView.setText(product);
        ...
        //Список клиентов
        ArrayList<HashMap<String, Object>> clients_GKII = new ArrayList<HashMap<String, Object>>();
...
//Создаем адаптер
        SimpleAdapter adapter = new SimpleAdapter(this, clients_GKII, R.layout.adapter_item, from, to);
